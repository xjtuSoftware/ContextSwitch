...
////added from Executor/////////////////////////////////////////////////////////////////////////////////////
	...
	// store the relation of join, key->threadId, value->a list of threads that are waiting key's termination
	...
	//线程调动记录
	std::multimap<unsigned, unsigned> interleaveRecord;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
private:
	...
	ExecutionState() :
			fakeState(false), underConstrained(0) {
	}
public:
